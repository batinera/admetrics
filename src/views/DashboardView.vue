<template>
  <div class="app">
    <div v-if="!useMock" class="user-bar">
      <span class="user-email">{{ user?.email }}</span>
      <RouterLink to="/onboarding" class="user-link">Fontes de dados</RouterLink>
      <button type="button" class="user-logout" @click="handleLogout">Sair</button>
    </div>
    <Header
      ...
      <div class="container">
        ...
        <div v-else-if="metrics">
          ...
          <div class="charts-grid">
            <PerformanceChart :time-series-data="timeSeriesData" />

            <div class="charts-row">
              <CostAnalysisChart :time-series-data="timeSeriesData" />
